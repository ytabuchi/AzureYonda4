...
namespace QRYonda.Models
{
    public class SignedRequestHelper
    {
        ...
        private byte[] secret;
        //private HMAC signer; // Remove from sample.
         ...
         *  CA: ecs.amazonaws.ca
         */
        public SignedRequestHelper(string awsAssociateTag, string awsAccessKeyId, string awsSecretKey, string destination, string idtype)
        {
            this.endPoint = destination.ToLower();
            this.atag = awsAssociateTag;
            this.akid = awsAccessKeyId;
            this.idtype = idtype;
            this.secret = Encoding.UTF8.GetBytes(awsSecretKey);

            //this.signer = new HMACSHA256(this.secret); // Remove from sample.
        ...
        public string Sign(IDictionary<string, string> request)
        {
            ...
            // Change to using PCLCtypto instead of 
        ...
        {
            // Change to WebUtility instead of HttpUtility because of PCL.
            // See: https://forums.xamarin.com/discussion/comment/97755/#Comment_97755
